    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Tizim sozlamalarini boshqarish</p>
        </div>
        <button 
          onClick={handleSave}
        ...
        <div className="lg:col-span-3">
          <AnimatePresence mode="wait">
            ...
            >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-gray-700">Tizim nomi</label>
                      <input 
                        type="text" 
                        defaultValue="UFF Football System"
                        className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1A56A0] focus:border-transparent"
                      />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-gray-700">Vaqt zonasi</label>
                      <select className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1A56A0] bg-white">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      rows={3}
                      defaultValue="O'zbekiston Futbol Federatsiyasi - Murabbiylar litsenziyalash tizimi"
                      className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1A56A0] focus:border-transparent resize-none"
                    />
                  </div>
                </div>
              )}
              ...
              {activeTab === 'security' && (
                <div className="space-y-6">
                  <h3 className="text-lg font-semibold text-gray-900 pb-4 border-b border-gray-100">Xavfsizlik sozlamalari</h3>
                  
                  <div className="space-y-4">
                    {[
                      { title: 'Ikki bosqichli autentifikatsiya', desc: 'SMS orqali tasdiqlash', enabled: true },
                      { title: 'Kuchli parol talabi', desc: 'Kamida 8 ta belgi, raqam va harf', enabled: true },
                      { title: 'Login urinishlarini cheklash', desc: '5 ta noto\'g\'ri urinishdan keyin bloklash', enabled: true },
                      { title: 'Seans vaqti', desc: '30 daqiqadan keyin avtomatik chiqish', enabled: false },
                    ].map((item, i) => (
                      <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                        ...
                        <button 
                          className={`w-14 h-7 rounded-full transition-all relative ${item.enabled ? 'bg-[#1A56A0]' : 'bg-gray-300'}`}
                        >
                          <div className={`w-6 h-6 bg-white rounded-full absolute top-0.5 transition-all ${item.enabled ? 'right-0.5' : 'left-0.5'}`} />
                        </button>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <h4 className="font-medium text-gray-900 mb-4">Parolni o'zgartirish</h4>
              ...
              {activeTab === 'notifications' && (
                <div className="space-y-6">
                  <h3 className="text-lg font-semibold text-gray-900 pb-4 border-b border-gray-100">Bildirishnoma sozlamalari</h3>
                  
                  <div className="space-y-4">
                    {[
                      { title: 'Yangi ariza kelganda', email: true, telegram: true },
                      { title: 'Litsenziya muddati tugashida', email: true, telegram: false },
                      { title: 'Tizim yangilanishlari', email: true, telegram: true },
                      { title: 'Xavfsizlik ogohlantirishlari', email: true, telegram: true },
                      { title: 'Oylik hisobotlar', email: false, telegram: false },
                    ].map((item, i) => (
                      <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                        <p className="font-medium text-gray-900">{item.title}</p>
                        <div className="flex gap-4">
                          <label className="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" defaultChecked={item.email} className="w-4 h-4 rounded border-gray-300 text-[#1A56A0] focus:ring-[#1A56A0]" />
                            <span className="text-sm text-gray-600">Email</span>
                          </label>
                          <label className="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" defaultChecked={item.telegram} className="w-4 h-4 rounded border-gray-300 text-[#1A56A0] focus:ring-[#1A56A0]" />
              ...
              {activeTab === 'system' && (
                <div className="space-y-6">
                  <h3 className="text-lg font-semibold text-gray-900 pb-4 border-b border-gray-100">Tizim sozlamalari</h3>
                  ...
                  <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-yellow-800 mt-1">Tizim sozlamalarini o'zgartirish avvalgi ishlab turgan funksiyalarga ta'sir qilishi mumkin.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {activeTab === 'appearance' && (
                <div className="space-y-6">
                  <h3 className="text-lg font-semibold text-gray-900 pb-4 border-b border-gray-100">Ko'rinish sozlamalari</h3>
                  
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-gray-700">Til</label>
                      <div className="flex gap-3">
                        {['O\'zbek', 'Русский', 'English'].map((lang, i) => (
                          <button 
                            key={lang}
                            className={`px-4 py-2 rounded-lg border transition-all ${i === 0 ? 'border-[#1A56A0] bg-blue-50 text-[#1A56A0]' : 'border-gray-200 hover:border-gray-300'}`}
                          >
                            {lang}
                          </button>
                        ))}
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-gray-700">Sana formati</label>
                      <select className="w-full px-4 py-2.5 border border-gray-200 rounded-lg bg-white md:w-64">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-gray-700">Vaqt formati</label>
                      <div className="flex gap-3">
                        {['24 soat', '12 soat'].map((format, i) => (
                          <button 
                            key={format}
                            className={`px-4 py-2 rounded-lg border transition-all ${i === 0 ? 'border-[#1A56A0] bg-blue-50 text-[#1A56A0]' : 'border-gray-200 hover:border-gray-300'}`}
                          >
