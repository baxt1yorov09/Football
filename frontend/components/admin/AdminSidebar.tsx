...
const menuItems = [
  ...
  { icon: FileText, label: 'Arizalar', id: 'applications' },
  { icon: Award, label: 'Litsenziyalar', id: 'licenses' },
    ...
    <aside className="fixed left-0 top-16 bottom-0 w-64 bg-white border-r border-gray-200 overflow-y-auto">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-[#F39C12]/10 to-[#E67E22]/10 rounded-lg">
          ...
          <span className="text-sm font-semibold text-[#F39C12]">Admin Panel</span>
        </div>
      </div>
      ...
      <div className="p-4 mt-4 border-t border-gray-200">
        <div className="p-4 bg-gradient-to-br from-[#0D3B6E] to-[#1A56A0] rounded-xl text-white">
          <h3 className="font-semibold mb-3">Tizim statistikasi</h3>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span className="opacity-80">Bugungi arizalar:</span>
              <span className="font-bold">12</span>
            </div>
            <div className="flex justify-between">
              <span className="opacity-80">Kutilayotgan:</span>
              <span className="font-bold">5</span>
            </div>
            <div className="flex justify-between">
              <span className="opacity-80">Faol litsenziyalar:</span>
